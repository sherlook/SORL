...
import numpy as np
from algos.offline.gbcq import GBCQ_Agent
from common.buffers import OfflineBuffer
from common.networks import MLPQsaNet, CVAE, BCQ_Perturbation, Generator, Discriminator
...
if __name__ == '__main__':
    ...
    parser.add_argument('--env', type=str, default='walker2d-medium-v2',
    ...
    parser.add_argument('--train_id', type=str, default='gbcq_walker2d-medium-v2_test',
    ...
    # *****************CGAN**************************
    generator = Generator(obs_dim=obs_dim, act_dim=act_dim, latent_dim=2 * act_dim)
