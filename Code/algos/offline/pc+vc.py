...
class PC_VC:
    ...
    def train(self, batch: TensorBatch) -> Dict[str, float]:
        ...
        # Compute critic loss
        critic_loss = F.mse_loss(current_q1, target_q) + F.mse_loss(current_q2, target_q)+ F.mse_loss(pi, action)
        ...
        if self.total_it % self.policy_freq == 0:
            ...
            actor_loss = -lmbda_1 * q.mean() + F.mse_loss(pi, action)
...
def train(config: TrainConfig):
    ...
    print("---------------------------------------")
    print(f"Training PC + VC, Env: {config.env}, Seed: {seed}")
    print("---------------------------------------")

    # Initialize actor
    trainer = PC_VC(**kwargs)
