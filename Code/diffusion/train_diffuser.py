...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='walker2d-expert-v2')
    ...
    #
    parser.add_argument('--results_folder', type=str, default='./results/walker2d-expert-v2')
    ...
    parser.add_argument('--save_file_name', type=str, default='5m-walker2d-expert-v2.npz')
